...
export class Backend implements backendInterface {
    ...
    async getAllBookTestSubmissions(): Promise<Array<[bigint, BookTestSubmission]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllBookTestSubmissions();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllContactSubmissions(): Promise<Array<[bigint, ContactSubmission]>> {
        if (this.processError) {
            try {
    ...
    async submitBookTest(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitBookTest(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
